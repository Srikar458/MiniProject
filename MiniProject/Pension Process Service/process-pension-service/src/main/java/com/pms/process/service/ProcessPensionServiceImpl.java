...
import com.pms.process.controller.ProcessPensionController;
...
public class ProcessPensionServiceImpl implements ProcessPensionService {
	...
	Logger log = LoggerFactory.getLogger(ProcessPensionServiceImpl.class);
	...
	{		
		log.debug("Aadhar No Input "+processPensionInput.getAadhaarNumber());		
